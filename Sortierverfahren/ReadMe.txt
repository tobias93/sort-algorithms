========================================================================
    KONSOLENANWENDUNG: Sortierverfahren-Projektübersicht
========================================================================

Diese Sortierverfahren-Anwendung wurde vom Anwendungs-Assistenten für Sie erstellt.

Diese Datei bietet eine Übersicht über den Inhalt der einzelnen Dateien, aus
denen Ihre Sortierverfahren-Anwendung besteht.


Sortierverfahren.vcxproj
...
Sortierverfahren.vcxproj.filters
...
StdAfx.h, StdAfx.cpp
    Mit diesen Dateien werden eine vorkompilierte Headerdatei (PCH) mit dem Namen Sortierverfahren.pch und eine vorkompilierte Typendatei mit dem Namen StdAfx.obj erstellt.
